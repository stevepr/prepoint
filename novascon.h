...
#define EXTERNC
   ...
   EXTERNC extern const short int FN1;
   EXTERNC extern const short int FN0;

/*
   TDB Julian date of epoch J2000.0.
*/

   EXTERNC extern const double T0;

/*
   Speed of light in meters/second is a defining physical constant.
*/

   EXTERNC extern const double C;

/*
   Light-time for one astronomical unit (AU) in seconds, from DE-405.
*/

   EXTERNC extern const double AU_SEC;

/*
   Speed of light in AU/day.  Value is 86400 / AU_SEC.
*/

   EXTERNC extern const double C_AUDAY;

/*
   Astronomical unit in meters.  Value is AU_SEC * C.
*/

   EXTERNC extern const double AU;

/*
   Astronomical Unit in kilometers.
*/

   EXTERNC extern const double AU_KM;
...
*/
   ...
   EXTERNC extern const double GS;
...
*/
   ...
   EXTERNC extern const double GE;

/*
   Radius of Earth in kilometers from IERS Conventions (2003).
*/

   EXTERNC extern const double ERAD;
...
*/
   ...
   EXTERNC extern const double ANGVEL;
...
*/
   ...
   EXTERNC extern const double RMASS[12];

/*
   Value of 2 * pi in radians.
*/

   EXTERNC extern const double TWOPI;

/*
   Number of arcseconds in 360 degrees.
*/

   EXTERNC extern const double ASEC360;

/*
   Angle conversion constants.
*/

   EXTERNC extern const double ASEC2RAD;
   EXTERNC extern const double DEG2RAD;
   EXTERNC extern const double RAD2DEG;
